...
*/
    ...
    isConfirmValid: function (Confirm) {
        return this.form.confirm.status = (this.password == Confirm);
    },
    ...
    isFormValid: function () {
        return this.form.username.status && this.form.sid.status && this.form.phone.status && this.form.email.status && this.form.password.status && ((typeof window != 'object') || this.form.confirm.status);
    },
