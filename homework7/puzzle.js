...
function shuffle() {
	...
	for (var j, x, i = number.length; i; j = parseInt(Math.random() * 2), x = number[--i], number[i] = number[j], number[j] = x);
...
function clickByRowAndCol(PArray) {
